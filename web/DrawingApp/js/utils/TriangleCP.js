class TriangleCP {
  ...
  draw() {
    ...
    const pureHue = ColorUtils.hsvToRgbArray(this.hue / 360, 1, 1);
    ...
    const paintRadius = this.currentBorderRadius + 0.5; // Use new property
  ...
  setColor(rgbString) {
    const rgb = ColorUtils.rgbStringToRgbArray(rgbString);
    if (!rgb) return;
