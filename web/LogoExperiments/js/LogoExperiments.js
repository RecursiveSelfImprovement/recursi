class LogoExperiments {
  async run(env) {
      ...
      // Background area - just for visual context, logos are placed in container
      ...
      // Spawn position - relative to this.container
  ...
  spawnLogo() {
      ...
      // Spawn into this.container so coordinates are relative to it, not the bg panel
