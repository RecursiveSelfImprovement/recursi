...
class SmartDrawKeys {
  ...
  static registerDrawingCommands(kch, baseController) {
    ...
    kch.addKeyCommand('command', 'black &key', '', function (type, keys) {
      if (type === 'command') baseController.setCommandByName('blackkey');
      if (type === 'queryactive') return true;
    });
  ...
  static showHelpDialog(baseController) {
      const hostContainer = baseController?.domElement?.parentElement || document.body;
      ...
      const directItems = [
        { keyStr: '<strong style="color:#4af;">L</strong>', desc: 'Smart Lock (lock nearest axis)' },
        { keyStr: '<strong style="color:#4af;">Space</strong>', desc: 'Toggle rectangular / polar / mixed mode' },
        { keyStr: '<strong style="color:#4af;">Left Click</strong>', desc: 'Place data point' },
        { keyStr: '<strong style="color:#4af;">Both Buttons</strong>', desc: 'Tentative snap to nearest element' },
        { keyStr: '<strong style="color:#4af;">Right Click</strong>', desc: 'Reset (release tentative \u2192 unlock \u2192 reset command)' },
        { keyStr: '<strong style="color:#4af;">Alt + Drag</strong>', desc: 'Rotate view' },
        { keyStr: '<strong style="color:#4af;">Shift + Drag</strong>', desc: 'Pan view' },
        { keyStr: '<strong style="color:#4af;">Alt + Scroll</strong>', desc: 'Zoom view' },
        { keyStr: '<strong style="color:#4af;">Type numbers</strong>', desc: 'Enter precise distance on active axis' },
        { keyStr: '<strong style="color:#4af;">Tab</strong>', desc: 'Switch active axis (X \u2194 Y)' },
        { keyStr: '<strong style="color:#4af;">Esc</strong>', desc: 'Clear all locks and input' },
      ];
      contentContainer.appendChild(createSection('Mouse & Direct Hotkeys', directItems));
