...
class InternalMemo {
  ...
  _buildHeader() {
      ...
      header.append(
        makeElement(
          ...
          InternalMemoContent.title()
        ),
        makeElement(
          'p',
          { className: 'blog-subtitle' },
          InternalMemoContent.subtitle()
        ),
        this._buildByline()
      );
      return header;
  ...
  _buildByline() {
      ...
      byline.innerHTML = InternalMemoContent.byline();
      return byline;
    }

  _buildBody() {
      const body = makeElement('div', { className: 'blog-body' });
      const sections = InternalMemoContent.sections();
  ...
  _buildFooter() {
      ...
      footer.innerHTML = 'internal context memo · not for public-facing copy';
      return footer;
    }
