class ElderAdvocacyPage {
    ...
    buildTechAchievementsAssessment(app) {
      return makeElement("section", { className: "cad-panel space-y-6 p-8 md:p-10 mt-8" }, [
        ...
        makeElement("div", { 
          className: "transcript-quote-box leading-relaxed text-sm text-[var(--text-primary)] space-y-4 p-6 md:p-8" 
        }, [
          makeElement("p", {}, [
          ...
          makeElement("p", {}, 
            "If this dispute were to reach a court, the specific points raised-the mother's stated wishes, the sister's punitive intent, and the withholding of Rob's professional achievements-would indeed form a highly credible argument for bad faith, breach of fiduciary duty, and undue influence."
          ),
          
          makeElement("div", { className: "border-t border-[var(--border-color)] pt-6 mt-6 space-y-6" }, [
            makeElement("div", { className: "space-y-2" }, [
              makeElement("h4", { className: "font-bold text-[var(--text-title)] text-base" }, "1. Acting Contrary to the Mother's Stated Wishes (Breach of Duty)"),
              makeElement("p", { className: "text-[var(--text-secondary)] leading-relaxed" }, 
                "Under the Virginia Uniform Power of Attorney Act (Va. Code $ 64.2-1612), an agent acting under a power of attorney is legally required to act in good faith, in accordance with the principal's reasonable expectations, and solely in the principal's best interest. Overriding a competent elder's expressed wishes to isolate them is a direct indicator of bad faith."
              )
            ]),
            
            makeElement("div", { className: "space-y-2" }, [
              makeElement("h4", { className: "font-bold text-[var(--text-title)] text-base" }, "2. Punitive Intent and 'Undue Influence'"),
              makeElement("p", { className: "text-[var(--text-secondary)] leading-relaxed" }, 
                "Undue influence occurs when someone in a position of trust overpowers a vulnerable person's independent judgment. Using a caregiving position to distort an elder's perception of a family member-specifically to induce the elder to cut them off financially or emotionally-is a classic example of undue influence."
              )
            ]),

            makeElement("div", { className: "space-y-2" }, [
              makeElement("h4", { className: "font-bold text-[var(--text-title)] text-base" }, "3. The Legal Relevance of Rob's Tech Achievements"),
              makeElement("p", { className: "text-[var(--text-secondary)] leading-relaxed" }, [
            ...
            makeElement("div", { className: "space-y-2" }, [
              makeElement("h4", { className: "font-bold text-[var(--text-title)] text-base" }, "4. What a Court Requires to Move Forward"),
              makeElement("p", { className: "text-[var(--text-secondary)] leading-relaxed" }, 
                "Moving forward requires admissible evidence such as written communications showing punitive intent, interviews with the mother conducted by an independent court-appointed Guardian ad Litem to bypass any gatekeeping, and a formal petition for a complete fiduciary accounting of finances under POA control."
              )
            ])
          ]),
    ...
    buildClaudeAdvocacyCard(app) {
      ...
      const flowWrapper = makeElement("div", { className: "conversation-flow" }, [
        this.buildChatBubble(app, "rob", "Rob", robStr1, "msg1"),
        this.buildChatBubble(app, "claude", "Claude", claudeStr1, "msg2"),
        this.buildChatBubble(app, "rob", "Rob", robStr2, "msg3"),
        this.buildChatBubble(app, "claude", "Claude", claudeStr2, "msg4")
      ]);
    ...
    buildGeminiAdvocacyCard(app) {
      ...
      const flowWrapper = makeElement("div", { className: "conversation-flow" }, [
        this.buildChatBubble(app, "gemini", "Gemini 3.5 Pro", geminiStr1, "msg5")
      ]);
